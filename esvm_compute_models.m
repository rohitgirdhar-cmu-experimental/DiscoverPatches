...
if ~exist('negdir', 'var')
  negdir = '/IUS/homes4/rohytg/projects/001_ESVM/datasets/negativeImages_1K'
end
...
if ~exist('imgsdir', 'var')
  imgsdir = '/IUS/vmr105/rohytg/projects/003_SelfieSeg/009_BgMatch/dataset/PeopleAtLandmarks/corpus'
end
if ~exist('outdir', 'var')
  outdir = '/IUS/homes4/rohytg/work/003_DiscoverPatches/results/PeopleAtLandmarks_ESVMModels'
end
